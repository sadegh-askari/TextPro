...
public class TextProContext : Editor
{
    ...
    //******************************************************
    //******************************************************
    [MenuItem("GameObject/UI Pro/Text - UGUI", false, 10)]
    private static void Create_UGUI_Text(MenuCommand menuCommand)
    {
        GameObject go = DefaultControls.CreateText(GetStandardResources());
        PlaceUIElementRoot(go, menuCommand);

        go.AddComponent<TextPro_UGUI>();
    }
    //******************************************************
    [MenuItem("GameObject/UI Pro/Button - UGUI", false, 10)]
    private static void Create_UGUI_Button(MenuCommand menuCommand)
    {
        ...
        if (text != null)
            text.gameObject.AddComponent<TextPro_UGUI>();
    }
    //******************************************************
    [MenuItem("GameObject/UI Pro/Text - TMPro", false, 10)]
    private static void Create_TMPro_Text(MenuCommand menuCommand)
    {
        GameObject go = DefaultControls.CreateText(GetStandardResources());
        PlaceUIElementRoot(go, menuCommand);

        ConvertToTextPro<TextMeshProUGUI, TextPro_TMPro>(go);
    }
    //******************************************************
    [MenuItem("GameObject/UI Pro/Button - TMPro", false, 10)]
    private static void Create_TMPro_Button(MenuCommand menuCommand)
    {
        GameObject go = DefaultControls.CreateButton(GetStandardResources());
        PlaceUIElementRoot(go, menuCommand);
    ...
    //******************************************************
    private static void ConvertToTextPro<T1, T2>(GameObject go) where T1 : Component where T2 : Component
    {
        ...
        if (texts != null)
        {
            ...
            {
                GameObject tGo = texts[i].gameObject;
